...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_tags_type" AS ENUM('Skill', 'Tag', 'Category');
  CREATE TYPE "public"."enum_experience_type" AS ENUM('Project', 'Work Experience', 'Volunteer');
  ...
  CREATE TABLE IF NOT EXISTS "experience" (
  	...
  	"type" "enum_experience_type" NOT NULL,
  ...
  DO $$ BEGIN
   ALTER TABLE "experience" ADD CONSTRAINT "experience_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
  ...
  DO $$ BEGIN
   ALTER TABLE "experience_rels" ADD CONSTRAINT "experience_rels_tags_fk" FOREIGN KEY ("tags_id") REFERENCES "public"."tags"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "experience_image_idx" ON "experience" USING btree ("image_id");
  ...
  CREATE INDEX IF NOT EXISTS "experience_rels_tags_id_idx" ON "experience_rels" USING btree ("tags_id");
