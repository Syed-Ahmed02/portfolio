...
export const Experience: React.FC<ExperienceComponentProps> = ({
  experiences,
}) => {
  ...
  useEffect(() => {
    ...
    if (activeTab === "work") {
      setDisplayData(
        experiences.filter((exp) => exp.type === "Work Experience")
      );
                ...
                <div className="md:flex">
                  ...
                  <div className="md:w-2/3">
                    ...
                    <CardContent className="px-6 pb-6">
                      <p className="mb-4 text-muted-foreground break-words">
                        {item.description}
                      </p>
                      ...
                      <CardFooter>
                        ...
                        >
                          <Button className="w-full" variant={"outline"}>
                            View <ExternalLink className="ml-2 size-5  " />
                          </Button>
                        </Link>
                      </CardFooter>
                    )}
